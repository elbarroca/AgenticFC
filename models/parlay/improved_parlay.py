...
PARLAY_OUTPUT_DIR_ELITE = DATA_OUTPUT_DIR / 'parlay_outputs_V5_elite_strategy' # NEW OUTPUT DIR

OOF_INPUT_PATH_DEFAULT = DATA_OUTPUT_DIR / 'prefiltered_elite_V5_oof.parquet' # Source of all predictions
